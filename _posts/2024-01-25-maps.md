...
A collection of maps I've made for others with the [lifeR](https://github.com/smsfrn/lifeR) workflow highlighting where they might be able to see new birds. See [this post](https:/smsfrn.github.io/posts/2024/01/lifer-mapper/) for more information.
